...
Ext.define("Ext.ux.StoreMenu", {
    ...
    onMenuLoad : function() {
        if(!this.loaded || this.autoReload) {
            // alert(JSON.stringify(this.store.data));
            this.store.load();
        }
    },
    ...
    updateMenuItems : function(records) {
        ...
        Ext.each(records, function(record, index) {
            ...
            if (record.data[this.configField]) {
                ...
                alert(record.data[this.idField]);
                menuSettings = {
                    id: record.data[this.idField],
                    text: record.data[this.nameField],
                    xtype: record.data[this.xtypeField],
            ...
            alert(JSON.stringify(menuSettings));
    ...
    constructor: function(config) {
        ...
        // }
        alert(this.idField);
        alert(this.store.data[0][this.idField]);
